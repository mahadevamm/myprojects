...
--
-- Host: 127.0.0.1    Database: profile1
-- ------------------------------------------------------
...
INSERT INTO `employeee` VALUES (1,'madhu','aa','sad','dsa','ds@gmail.com');
...
-- Dump completed on 2017-09-18 10:33:53
-- MySQL dump 10.13  Distrib 5.7.19, for Linux (x86_64)
--
-- Host: 127.0.0.1    Database: profile1
-- ------------------------------------------------------
...
--
-- Dumping data for table `namedata`
--

LOCK TABLES `namedata` WRITE;
/*!40000 ALTER TABLE `namedata` DISABLE KEYS */;
/*!40000 ALTER TABLE `namedata` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
